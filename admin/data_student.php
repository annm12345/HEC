            ...
            <div class="card">
              <div class="card-header">
                ...
                <div style="display:flex;position:absolute;top:5px;right:20px;">
                  <a href="student_manage.php" class="btn btn-primary">ADD</a>
                </div>
              </div>
              <!-- /.card-header -->
              <div class="card-body" >
                <table id="example2" class="table table-bordered table-hover" >
                  ...
                  <tbody >
                    ...
                    if(isset($_GET['specialization']) && $_GET['specialization']!=''){
                      $specialization=$_GET['specialization'];
                      $res=mysqli_query($con,"SELECT * FROM `student` WHERE specialization='$specialization'");
                  ...
                  <tr id="table">
                    ...
                    <td><a href="student_manage.php?id=<?php echo $row['id']; ?>" class="btn btn-info">EDIT</a> | <a href="data_student.php?action=delete?id=<?php echo $row['id']; ?>&specialization=<?php echo $row['specialization'] ?>" class="btn btn-danger">DELETE</a></td>
                  </tr>
                  <?php  } }  ?>
