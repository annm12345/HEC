        ...
        <div class="container-fluid">
            ...
            <div class="col-12 col-sm-6 col-md-3">
                ...
                <div class="info-box-content">
                    ...
                    <a href="data_teacher.php?specialization=<?php echo $row['department'] ?>"><span class="info-box-number">
                    <?php
                    $sres=mysqli_query($con,"select * from `teacher` where specialization='$department'");
